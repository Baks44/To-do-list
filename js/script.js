{
    ...
    if (toggleHideDoneTasksButton) {
        toggleHideDoneTasksButton.innerText = hideDoneTasks ? "Pokaż ukończone" : "Ukryj ukończone";
    }
    ...
    const render = () => {
        ...
        if (markAllDoneButton) {
            markAllDoneButton.disabled = tasks.length === 0 || tasks.every(({ done }) => done);
        }
        bindRemoveEvents();
